...
export const FocusedPolicyOption: React.FC<{
  ...
  ({ option, area, isSelected, isDisabled, onSelect, opponentSelected }) => {
    const t = useTranslations("");
    ...
    return (
      ...
      >
        ...
        {opponentSelected && (
          <div className="absolute -top-2 -right-2 bg-blue-500 text-white rounded-full p-1 shadow-md border-2 border-white">
